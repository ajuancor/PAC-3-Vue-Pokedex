  ...
  <main class="main-llista" :class="{'error-detail' : error}">
    ...
    <div class="content-searcher">
      <div class="restart-starters">
          <button @click="restartPokemon()" id="btn-restart-starters" class="btn btn-retrostyle btn-restart-starter">Reiniciar inicials <img class="iconbtn" src="@/assets/img/iconbtn.jpg"></button>
      </div>
